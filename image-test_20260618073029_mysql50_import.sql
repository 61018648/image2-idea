...
CREATE TABLE `_prisma_migrations` (
  ...
  `checksum` varchar(64) COLLATE utf8_general_ci NOT NULL,
  `finished_at` datetime DEFAULT NULL,
  `migration_name` varchar(255) COLLATE utf8_general_ci NOT NULL,
  `logs` text COLLATE utf8_general_ci,
...
CREATE TABLE `balances` (
  `user_id` varchar(128) COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `credit_ledger` (
  ...
  `source` varchar(32) COLLATE utf8_general_ci NOT NULL,
  `source_id` varchar(191) COLLATE utf8_general_ci DEFAULT NULL,
...
CREATE TABLE `generation_jobs` (
  `id` varchar(128) COLLATE utf8_general_ci NOT NULL,
  `user_id` varchar(128) COLLATE utf8_general_ci NOT NULL,
  `status` varchar(32) COLLATE utf8_general_ci NOT NULL DEFAULT 'queued',
  `prompt` text COLLATE utf8_general_ci NOT NULL,
  `request_params` longtext NOT NULL,
  `input_image_data` longtext NOT NULL,
  `mask_data_url` longtext COLLATE utf8_general_ci,
  `cost_credits` int(11) NOT NULL,
  `images` longtext NOT NULL,
  `raw_image_urls` longtext DEFAULT NULL,
  `revised_prompts` longtext DEFAULT NULL,
  `actual_params` longtext DEFAULT NULL,
...
CREATE TABLE `orders` (
  `id` varchar(128) COLLATE utf8_general_ci NOT NULL,
  `user_id` varchar(128) COLLATE utf8_general_ci NOT NULL,
  `plan_id` varchar(128) COLLATE utf8_general_ci NOT NULL,
  `status` varchar(32) COLLATE utf8_general_ci NOT NULL DEFAULT 'pending',
  `amount_cents` int(11) NOT NULL,
  `currency` varchar(8) COLLATE utf8_general_ci NOT NULL DEFAULT 'USD',
  `credits` int(11) NOT NULL,
  `provider` varchar(32) COLLATE utf8_general_ci NOT NULL,
  `provider_order_id` varchar(191) COLLATE utf8_general_ci DEFAULT NULL,
  `provider_payment_id` varchar(191) COLLATE utf8_general_ci DEFAULT NULL,
  `created_at` datetime NOT NULL DEFAULT '1970-01-01 00:00:00',
...
CREATE TABLE `payment_events` (
  `id` varchar(128) COLLATE utf8_general_ci NOT NULL,
  `provider` varchar(32) COLLATE utf8_general_ci NOT NULL,
  `provider_event_id` varchar(128) COLLATE utf8_general_ci NOT NULL,
  `order_id` varchar(128) COLLATE utf8_general_ci DEFAULT NULL,
...
CREATE TABLE `user_accounts` (
  `id` varchar(128) COLLATE utf8_general_ci NOT NULL,
  `email` varchar(191) COLLATE utf8_general_ci DEFAULT NULL,
  `password_hash` varchar(255) COLLATE utf8_general_ci DEFAULT NULL,
  `display_name` varchar(191) COLLATE utf8_general_ci DEFAULT NULL,
  `role` varchar(32) COLLATE utf8_general_ci NOT NULL DEFAULT 'user',
  `status` varchar(32) COLLATE utf8_general_ci NOT NULL DEFAULT 'active',
